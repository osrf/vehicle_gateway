...
print(f'VTOL state: {px4_gateway.get_vtol_state()}')
...
print(f'Flight mode: {px4_gateway.get_flight_mode()} - VTOL state: {px4_gateway.get_vtol_state()}')
...
print(f'Flight mode: {px4_gateway.get_flight_mode()}')
