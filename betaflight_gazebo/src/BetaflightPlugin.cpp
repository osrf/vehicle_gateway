...
// Register plugin
GZ_ADD_PLUGIN(betaflight_gazebo::BetaFlightPlugin,
              gz::sim::System,
...
class betaflight_gazebo::BetaFlightPluginPrivate
{
  ...
  public: std::string fdm_addr{"127.0.0.1"};

  /// \brief The address for the SITL flight controller - auto detected
  public: std::string listen_addr{"127.0.0.1"};
...
/////////////////////////////////////////////////
void betaflight_gazebo::BetaFlightPlugin::Reset(const gz::sim::UpdateInfo &_info,
...
/////////////////////////////////////////////////
bool betaflight_gazebo::BetaFlightPlugin::ReceiveServoPacket(double _simTime,
  const gz::sim::EntityComponentManager &_ecm)
{
    ...
    //     return false;
    // }
    // gzerr << "recvSize " << recvSize << " this->dataPtr->betaflightOnline " << this->dataPtr->betaflightOnline << std::endl;
...
/////////////////////////////////////////////////
void betaflight_gazebo::BetaFlightPlugin::SendState(double _simTime,
